...
const mockPush = jest.fn(); const mockBack = jest.fn(); const mockComplete = jest.fn().mockResolvedValue(null); const mockResend = jest.fn().mockResolvedValue(null); const mockRetryProvisioning = jest.fn().mockResolvedValue(null);
...
jest.mock('@/contexts/AuthContext', () => ({ useAuth: () => ({ completeEmailUpgrade: mockComplete, resendEmailUpgrade: mockResend, retryEmailUpgradeProvisioning: mockRetryProvisioning }) }));
