export default {
  ...
  profile: {
    ...
    newsletterOn: 'Enabled',
    newsletterOff: 'Disabled',
  ...
  terrain: {
    manualButtonLabel: 'Validate on-site',
    searchingTitle: 'On-site confirmation',
    searchingBody: 'Finding your location…',
    gpsConfirmed: 'Location confirmed · %{peak}',
    gpsUnavailable: 'Location unavailable',
    forecastRecall: 'Last night, the forecast said %{score}% (%{verdict}) · %{peak}',
    question: 'Did you see the sea of clouds?',
    answerYes: 'Yes',
    answerNo: 'No',
    later: 'Later',
    deniedTitle: "We couldn't find you",
    deniedBody: 'No worries — you can confirm it yourself, no location needed.',
    validateManually: 'Validate manually',
    successTitle: 'Thank you!',
    successBody: 'Your answer helps refine forecasts 🙏',
    close: 'Close',
  },
};
