...
// EXPO_PUBLIC_SUPPORT_EMAIL can override the public support mailbox per environment.
const SUPPORT_EMAIL = process.env.EXPO_PUBLIC_SUPPORT_EMAIL ?? 'contact@cloudbreak-app.com';
